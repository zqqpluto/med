    ...
    <div>
        <div>
            <div style="display: flex;justify-content: space-between">
                ...
                <!-- <div>
                    <el-button type="primary" icon="el-icon-plus" @click="showAddEmpView">添加媒体资料</el-button>
                </div> -->
            </div>
        </div>
        <div style="margin-top: 10px">
            ...
            >
                ...
                <el-table-column prop="atitle"  align="left" label="标题" width="400"></el-table-column>

                <el-table-column prop="mname"  align="left" label="公司名或政府部门" width="400"></el-table-column>
...
export default {
    ...
    methods: {
        ...
        deleteEmp(data) {
            this.$confirm('此操作将永久删除【' + data.atitle + '】, 是否继续?', '提示', {
                confirmButtonText: '确定',
                cancelButtonText: '取消',
                type: 'warning'
            })
                .then(() => {
                    this.deleteRequest('/anounce/' + data.id).then(resp => {
                        if (resp) {
                            this.initEmps();
                        }
                    });
        ...
        initEmps(type) {
            this.loading = true;
            let url = '/anounce?page=' + this.page + '&size=' + this.size;
                url += '&userName=' + window.sessionStorage.getItem('ms_username');
                url += '&nameSearch='+this.userNameSearch;
