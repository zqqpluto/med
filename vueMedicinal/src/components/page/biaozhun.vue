    ...
    <div>
        <div>
            <div style="display: flex;justify-content: space-between">
                ...
                <div>
                    <el-button type="primary" icon="el-icon-plus" @click="showAddEmpView">添加标准规范</el-button>
                </div>
            </div>
        </div>
        <div style="margin-top: 10px">
            ...
            >
                ...
                <el-table-column prop="mname"  align="left" label="公司名或政府部门" width="300"></el-table-column>
    ...
    methods: {
        ...
        initEmps(type) {
            ...
            let url = '/knowledgeService?page=' + this.page + '&size=' + this.size;
                ...
                url += '&nameSearch='+this.userNameSearch+ "&kcid=1008";
