    ...
    <div>
        <div>
            <div style="display: flex;justify-content: space-between">
                ...
                <div>
                    <el-button type="primary" icon="el-icon-plus" @click="showAddEmpView">添加生产企业</el-button>
                </div>
            </div>
        </div>
        <div style="margin-top: 10px">
            ...
            >
                ...
                <el-table-column prop="kspath"  align="left" label="官网" width="300"></el-table-column>
    ...
    methods: {
        ...
        initEmps(type) {
            ...
            let url = '/knowledgeService?page=' + this.page + '&size=' + this.size;
                ...
                url += '&nameSearch='+this.userNameSearch+ "&kcid=1010";
